...
def create_video_with_gaze_directions(output_dir, video_path, start_frame=0, end_frame=1):
    # Open the video file
    ...
    while True:
        ...
        if len(frame_batch) % 7 == 0:
            ...
            draw_gaze_direction(output_gazes, gaze_start_coords_dict, frame_batch, frames_processed)
